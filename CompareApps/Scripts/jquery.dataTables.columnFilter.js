    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected) {
            ...
            if (currentFilter == null || currentFilter == "")//Issue 81
                ...
                //Modified by Sam Sushil on Apr 09,2013 to fix default filter colunm width
           //var r = '<select class="search_init select_filter" style="width:100px"><option value="" class="search_init">' + sLabel + '</option>';
            ...
            select.change(function () {
                ...
                //changes by Sam Sushil for exact match
                // if (bRegex)
                ...
                if (bRegex)
                    ...
                    if ($(this).val()) {
                        ...
                        oTable.fnFilter($(this).val(), iColumn, true);
                    }
                }
                fnOnFiltered();
            });
